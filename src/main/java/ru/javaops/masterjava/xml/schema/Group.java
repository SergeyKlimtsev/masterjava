...
public class Group {
    ...
    public static class Members {
        ...
        @XmlElementRef(name = "UserID", namespace = "http://javaops.ru", type = JAXBElement.class, required = false)
        protected List<JAXBElement<Object>> userID;
         ...
         * 
         */
        public List<JAXBElement<Object>> getUserID() {
            if (userID == null) {
                userID = new ArrayList<JAXBElement<Object>>();
            }
            return this.userID;
        }
